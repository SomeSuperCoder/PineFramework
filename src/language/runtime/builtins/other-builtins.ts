...
export function registerOtherBuiltins(engine: ExecutionEngine): void {
  ...
  eng.builtins.set('table.new', (): PineValue => {
    return 0; // table ID
  });

  eng.builtins.set('table.cell', (): PineValue => {
    return NA;
  });

  eng.builtins.set('table.get_cell_text', (): PineValue => {
    return '';
  });

  eng.builtins.set('table.get_cell_text_color', (): PineValue => {
    return '';
  });

  eng.builtins.set('table.get_cell_bgcolor', (): PineValue => {
    return '';
  });

  eng.builtins.set('table.set_cell_text', (): PineValue => {
    return NA;
  });

  eng.builtins.set('table.set_cell_text_color', (): PineValue => {
    return NA;
  });

  eng.builtins.set('table.set_cell_bgcolor', (): PineValue => {
    return NA;
  });

  eng.builtins.set('table.set_cell_width', (): PineValue => {
    return NA;
  });
