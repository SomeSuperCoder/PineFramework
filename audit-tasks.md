...
- [x] **H-005** | [Bug-OrderFill] | `src/strategy/strategy-engine.ts:861-920` | Stop-limit orders can be filled at incorrect prices
...
- [x] **H-008** | [Bug-Interpreter] | `src/language/runtime/interpreter.ts:813-821` | Named arguments passed to builtins may overwrite positional arguments (deferred — current behavior preserves named args needed by plot builtins; calculation builtins naturally ignore extra args)
