...
The system SHALL guide the user through selecting, in order: strategy, symbol, timeframe, days-back, commission method. Each step SHALL present the current choice and allow going back or restarting.
