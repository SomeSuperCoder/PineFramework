...
> **Note**: This requirement is extended to include alert details in the crosshair tooltip. See `alert-tooltip-display` spec for the full alert display behavior.
