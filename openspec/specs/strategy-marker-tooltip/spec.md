## Purpose
Implement and verify the display of strategy marker details (entry, exit, close, order, cancel) in the chart bar tooltip for the strategy-marker-tooltip module.
