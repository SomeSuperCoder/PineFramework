...
The "Re-run Backtest" button SHALL advance the wizard to the Backtest step and trigger the backtest automatically.
...
- **AND** the backtest SHALL start automatically without requiring additional user input
