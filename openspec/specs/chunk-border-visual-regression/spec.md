## Purpose
Detect and diagnose visual regression issues related to null plot values near chunk boundaries, and expose diagnostic data for Playwright-based regression tests.
