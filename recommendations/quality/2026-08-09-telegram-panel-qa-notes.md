...
4. **frontend** — Follow-up modernize pass on BacktestPanel so the exemplar matches the new panel's Tailwind-token/lucide standard. (SettingsPanel removed 2026-08-11 — no longer applicable.)
