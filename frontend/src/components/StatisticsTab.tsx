...
const NO_TRADES = (
  <div className="p-8 text-center text-[12px] text-muted-foreground">No trades yet.</div>
);
            ...
            {error && !summary ? (
              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
                ...
                <div className="space-y-1">
                  ...
                  <div
                    className="font-mono text-sm"
                    title="Fees are not included in this version -- always 0 (real fee parsing deferred)"
                  >
